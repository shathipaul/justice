    ...
    return (
        <>
            <div className='text-center py-8 '>
                ...
                <p className=' lg:w-3/5 m-auto text-sm'>There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form, by injected humour.</p>
            </div>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3'>
                {
                    serviceData.map(data => <div
                        className='flex  flex-col items-center justify-center px-8 py-2'
                        key={data.id}>
